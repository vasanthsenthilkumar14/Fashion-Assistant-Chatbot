...
def test_collection():
    ...
    # print(fashion_collection.get(
    #     include=["documents"]
    # ))

    # Test collection retrieval
    # print(fashion_collection.get(
    #     ids=['18244250', '15498982'],
    #     include=["documents", "metadatas"]
    # ))

    results = fashion_collection.query(
        query_texts=["Rayon fabric Kurtha under 2000 and color white"],
        n_results=10,
        include=["documents", "metadatas"],
...
if __name__ == "__main__":
    ...
    query = "Rayon fabric Kurtha"

    # Moderation check for user input
    moderation_result = check_moderation(query.lower())
    ...
    reranked_results_df = rerank_results(query, results_df)
    # print(reranked_results_df)
    # top_5_semantic = results_df.sort_values(by='Distances').head(5)
    ...
    top_5_RAG.to_csv('top_5_RAG.csv', index=False)

    message = generate_response(query, top_5_RAG)
    # Display the message neatly
    for line in message:
        print(line)